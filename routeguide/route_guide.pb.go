...
var file_route_guide_proto_rawDesc = []byte{
	...
	,
...
var file_route_guide_proto_depIdxs = []int32{
	0, // 0: RouteGuide.SayHello:input_type -> HelloRequest
	2, // 1: RouteGuide.EchoService:input_type -> Message
	1, // 2: RouteGuide.SayHello:output_type -> HelloReply
	2, // 3: RouteGuide.EchoService:output_type -> Message
...
func (c *routeGuideClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/RouteGuide/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routeGuideClient) EchoService(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/RouteGuide/EchoService", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedRouteGuideServer) SayHello(context.Context, *HelloRequest) (*HelloReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHello not implemented")
}
func (*UnimplementedRouteGuideServer) EchoService(context.Context, *Message) (*Message, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EchoService not implemented")
}
...
func _RouteGuide_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/RouteGuide/SayHello",
	}
...
func _RouteGuide_EchoService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RouteGuideServer).EchoService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/RouteGuide/EchoService",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouteGuideServer).EchoService(ctx, req.(*Message))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RouteGuide_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RouteGuide_EchoService_Handler,
		},
	},
